...
class CalloutsControllerTest < ActionController::TestCase
  ...
  test "should create callout" do
    assert_difference('Callout.count') do
      post :create, callout: { callout_content: @callout.callout_content, callout_title: @callout.callout_title }
    end
  ...
  test "should update callout" do
    patch :update, id: @callout, callout: { callout_content: @callout.callout_content, callout_title: @callout.callout_title }
    assert_redirected_to callout_path(assigns(:callout))
  end
